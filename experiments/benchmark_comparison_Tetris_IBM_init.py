    ...
    for filename in file_list:
        ...
        if filename.endswith(".json"):
            ...
            if save_output == True:
                ...
                with open(f'../experiments/tetris_partial_results_ibm/' + save_filename, 'wb') as paulis_file:
...
def run_experiment_paulis(test_paulis, test_params = None, save_output = False, filename = "Paulis"):
    ...
    if save_output == True:
        # Save to pickle files
        with open(f'../experiments/tetris_partial_results_ibm/' + filename, 'wb') as paulis_file:
